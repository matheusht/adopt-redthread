...
.PHONY: test demo-zapi demo-zapi-har demo-redthread-runtime demo-redthread-dryrun demo-adopt-actions demo-gate demo-all
...
demo-all: demo-zapi demo-zapi-har demo-redthread-runtime demo-redthread-dryrun demo-adopt-actions demo-gate
