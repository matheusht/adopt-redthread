...
- `live_workflow_replay_demo.md` — grouped multi-step workflow replay with stop-on-first-failure, bounded evidence carry-forward, and structured failure reasons
