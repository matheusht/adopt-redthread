...
def build_har_batch_review_workflow(batch_dir: str | Path, output_dir: str | Path | None = None) -> dict[str, Any]:
    ...
    phase6 = {
        ...
        "intent_review_artifacts": [
            ...
            "redthread_execution_handoff_validation.json",
            ...
            "pentest_context_package_v0/manifest.json",
            "pentest_context_package_v0/pentest_context_package.json",
            "pentest_context_package_v0/pentest_agent_handoff.json",
            "pentest_context_package_v0/pentest_agent_brief.md",
            "pentest_context_package_v0/reviewer_packet.md",
        ...
        "execution_candidate_count": intent_review_result.get("execution_candidate_count"),
        "ready_for_redthread_review_count": intent_review_result.get("ready_for_redthread_review_count"),
        "execution_handoff_path": "intent_review/redthread_execution_handoff.json",
        "redthread_intent_evidence_path": "intent_review/redthread_intent_evidence.json",
        "redthread_importable": intent_review_result.get("redthread_importable"),
        "candidate_workflow_created": intent_review_result.get("candidate_workflow_created"),
        "candidate_workflow_import_path": "intent_review/redthread_candidate_workflow_import.json",
        "product_proof_passed": intent_review_result.get("product_proof_passed"),
        "pentest_context_package_path": "intent_review/pentest_context_package_v0",
        "pentest_context_package_valid": intent_review_result.get("pentest_context_package_valid"),
