...
class BridgeWorkflowTests(unittest.TestCase):
    def test_full_bridge_workflow_runs_from_sample_har(self) -> None:
        ...
        self.assertIn("live_workflow_binding_audit_summary", workflow_summary)
        ...
        self.assertIn("auth_diagnostics_summary", workflow_summary)
        ...
        self.assertEqual(workflow_summary["auth_diagnostics_summary"]["auth_mode"], "api_key")
        self.assertTrue(workflow_summary["auth_diagnostics_summary"]["auth_context_gap"])
        self.assertTrue(workflow_summary["auth_diagnostics_summary"]["write_context_gap"])
        ...
        self.assertEqual(workflow_summary["live_workflow_binding_audit_summary"], {})
    ...
    def test_cli_bridge_pipeline_emits_summary_json(self) -> None:
        ...
        self.assertIn("auth_diagnostics_summary", summary)
